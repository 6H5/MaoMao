;(function () {
    ...
    $('main').on('click','a.admin',function(){
        ...
        $('body').append('<div class="MMLY-add MMLY-admin"><p><input type="password" class="pwd" style="text-align:center;" placeholder="管理密码"/></p><p><button class="MMLY-admin-ok-btn">确定</button></p><p><button class="MMLY-admin-cancel-btn">取消</button></p></div>')
    })
    // 隐藏管理密码
